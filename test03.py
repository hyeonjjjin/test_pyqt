import sys
from PyQt5.QtWidgets import QApplication, QWidget, QVBoxLayout, QHBoxLayout, QFrame, QSplitter
from PyQt5.QtWidgets import QGroupBox, QGridLayout, QPushButton, QCheckBox, QRadioButton
